...
<body ng-app="origin" ng-controller="originCtrl" account-profile>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li class="active"><a href="origin.php"><i class="fas fa-comment-alt"></i>Origin</a> </li>
                            </ul>
                        </li>
                    </ul>
                </nav>
...
">
    ...
    <script src="modules/origin.js"></script>
    <script src="controllers/origin.js"></script>
