...
<body ng-app="agency" ng-controller="agencyCtrl" account-profile>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li class="active"><a href="agency.php"><i class="fas fa-comment-alt"></i>Agency</a> </li>
                                ...
                                <li><a href="position.php"><i class="fas fa-comment-alt"></i>Position</a> </li>
                                <li><a href="origin.php"><i class="fas fa-comment-alt"></i>Origin</a> </li>
                            </ul>
                        </li>
                    </ul>
                </nav>
...
">
    ...
    <script src="modules/agency.js"></script>
    <script src="controllers/agency.js"></script>
