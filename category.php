...
<body ng-app="category" ng-controller="categoryCtrl" account-profile>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li class="active"><a href="category.php"><i class="fas fa-comment-alt"></i>Category</a> </li>
                            </ul>
                        </li>
                    </ul>
                </nav>
...
">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mx-auto w-100 col-xl-14">
                                ...
                                <!-- Category DATA-->
                                <div class="category-data m-b-100">
    ...
    <script src="modules/category.js"></script>
