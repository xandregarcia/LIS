...
$user = $con->getData("SELECT * FROM `tbl_ordinance` join `tbl_communication` on `tbl_ordinance`.ctrl_no = `tbl_communication`.ctrl_no WHERE id = $_POST[id]");
